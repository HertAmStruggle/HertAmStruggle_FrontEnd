    ...
    return regions && (
        <div className={styles.formContainer}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset className={styles.inputGroup}>
                    <label className={styles.customField}>
                        <span>Subtype</span>{errors.subType && <span className={styles.error}>{errors.firstname}</span>}
                        <input type="text" name="subType" onChange={handleChange} value={prescription.firstname}/>
                    </label>
                </fieldset>
